...
<div class="btn btn-primary pd-5 rounded-pill btn-lg active bns"   data-toggle="modal" data-target="#list"   >ADD LIST <i class="fa fa-plus float-right mt-1 ml-1"></i>
  	</div>
	...
	<input type="text" onkeyup="jax(this)" id="<?php echo $row['todolist_id']?>" placeholder="Add New Todo">
           <?php
           $to=$row['todolist_id'];
           $taks = $db->ajax($to);
            ...
            <div class="modal-body">
              <form  action="edit_list.php" method="POST">
                <div class="form-group">
                  <input type="text" class="form-control" name="name" placeholder="TO DO LIST NAME">
                </div>
                <div class="form-group">
